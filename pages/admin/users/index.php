...
<body>
  ...
  <div class="">
    ...
    <ul>
        ...
        <li class="active">
          <a href="../dash-admin.php" class="active">
        ...
        <li>
          <a href="#">
            <span class="title"><i class='bx bxs-user'></i>Users</span>
          </a>
        </li>
        ...
        <li>
          <a href="../Teachers/teachers.php">
            <span class="title"><i class='bx bxs-bookmark-alt'></i>Teachers</span>
          </a>
        </li>

        <li>
          <a href="../marks/marks.php">
            <span class="title"><i class='bx bxs-cog'></i>Marks</span>
          </a>
        </li>
        <li>
          <a href="../absences/absences.php">
            <span class="title"><i class='bx bxs-cog'></i>absences</span>
          </a>
        </li>
        <li>
          <a href="../booking/booking.php">
            <span class="title"><i class='bx bxs-cog'></i>Books</span>
          </a>
        </li>
        <div>
  ...
  <div class="header">
    ...
    <div class="search">
      ...
      <div class="icons">
        <img src="../../../assets/images/bell.png" style="width: 40px;height: 40px;" alt="" srcset="">
      </div>
      <div class="admin">
        <img src="../../../assets/images/omar.png" alt="" srcset="">
        <div class="name">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col-md-8 offset-md-2 text-center">
                ...
                <div class="h3 mb-2 font-weight-bold text-black">Total Users</div>
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col-md-8 offset-md-2 text-center">
                ...
                <div class="h3 mb-2 font-weight-bold text-black">Total Books</div>
                <div class="h5 mb-4 font-weight-bold text-gray-800">10,000+ / year</div>
                <div class="h6 mb-0 font-weight-bold text-gray-800">15% increase from last year</div>
              </div>
            </div>
              ...
              <table class="table table-borderless">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><img src="../../../<?php echo $rows['Profil'];?>" style="width:40px;height:40px"></td>
                    <td><?php echo $rows['Roles'];?></td>
                    <td style="display: flex;" >
                      <button class="btn btn-default" ><a href="update-user.php?id=<?= $rows['id'] ?>"><i class='bx bx-edit-alt' style='color:#8a8b8c'  ></i></a></button><button class="btn btn-default"><a href="../../../controller/admin/delete.php?id=<?=$rows['id'] ?>"><i class='bx bx-trash' style='color:#fe3030' ></i></a></button>
                    </td>  
